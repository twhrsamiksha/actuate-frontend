...
const WhyActuatePage = () => {
  const features = [
    {
      icon: Globe,
      title: "Content that's at par with any available globally",
              ...
              <div key={index} className={`grid md:grid-cols-2 gap-8 md:gap-12 lg:gap-16 items-center ${index % 2 === 1 ? 'md:flex-row-reverse' : ''}`}>
                ...
                <div className={`relative ${index % 2 === 1 ? 'md:order-1' : ''}`}>
                  <div className="relative overflow-hidden rounded-2xl shadow-xl">
                    ...
                    <div className="aspect-[4/3] bg-gradient-to-br from-primary/10 to-primary/5 items-center justify-center" style={{display: 'none'}}>
