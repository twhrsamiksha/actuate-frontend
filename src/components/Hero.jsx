...
const Hero = () => {
  return (
    // Hidden on mobile (below md), visible from md breakpoint onwards
    <section className="relative w-full bg-accent hidden md:block">
      <Swiper
        ...
        loop
        className="w-full h-[30vh] lg:h-[45vh]"
      >
          ...
          <div className="relative w-full h-full">
            ...
            <div className="absolute inset-0 flex items-center justify-end">
              <div className="container mx-auto px-8 lg:px-12 max-w-7xl">
                <div className="max-w-xl ml-auto space-y-4 animate-fade-in text-right pr-8">
                  ...
                  <div className="pt-2 flex justify-end">
                    <Link to="/legacy-effect">
                      <button className="bg-primary text-white px-7 py-3.5 rounded-lg font-semibold hover:bg-primary/90 hover:shadow-xl transition-all duration-300 flex items-center gap-2 group">
